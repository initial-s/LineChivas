...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"please Like my URL\n like back ..?? pc adja \nURL: http://line.me/R/home/public/post?id=dis9114z&postId=1150788004004035493",
    "lang":"JP",
    "comment":"please Like my URL\n like back ..?? pc adja \nURL: http://line.me/R/home/public/post?id=dis9114z&postId=1150788004004035493",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
    try:
        ...
        if op.type == 26:
               ...
               if wait["wblack"] == True:
            ...
            elif ("RUN1 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("RUN1 gn ","")
                    ki.updateGroup(X)
                else:
                    ki.sendText(msg.to,"It can't be used besides the group.")
            elif ("RUN2 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("RUN2 gn ","")
                    kk.updateGroup(X)
                else:
                    kk.sendText(msg.to,"It can't be used besides the group.")
            elif ("RUN3 gn " in msg.text):
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("RUN3 gn ","")
                    kc.updateGroup(X)
                else:
            ...
            elif "RUN1 kick " in msg.text:
                midd = msg.text.replace("RUN1 kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "RUN2 kick " in msg.text:
                midd = msg.text.replace("RUN2 kick ","")
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"▣▣pendingan kosong bous▣▣")
                        else:
                            cl.sendText(msg.to,"Tidak ada yang perlu di cencel")
                else:
                    if wait["lang"] == "JP":
                ...
                cl.sendText(msg.to,mid)
            elif "RUN1 mid" == msg.text:
                ki.sendText(msg.to,Amid)
            elif "RUN2 mid" == msg.text:
                kk.sendText(msg.to,Bmid)
            elif "RUN3 mid" == msg.text:
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Ok double thumbs up􏿿")
...
#------------------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"BL Done , makanya jangan nakal,, Kena BL kan lu")
                    ki.sendText(msg.to,"BL Done , makanya jangan nakal,, Kena BL kan lu")
                    kk.sendText(msg.to,"BL Done , makanya jangan nakal,, Kena BL kan lu")
                    kc.sendText(msg.to,"BL Done , makanya jangan nakal,, Kena BL kan lu")
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					...
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"⇨Done Like\n please like back my URL\n->>URL: http://line.me/R/home/public/post?id=dis9114z&postId=1150788004004035493")

						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)

						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"->>DONE Like \n Please like back my URL \n URL: http://line.me/R/home/public/post?id=dis9114z&postId=1150788004004035493")
